# sana2b-kernel_aw-0001

Run workflow `kernel_aw` for model `sana_video_2b_h100`
under aspect `kernel` using the experiment-local baseline copy.
...
`TRAJECTORY.jsonl`, and the official 40-round Kernel cap/plateau rule.
