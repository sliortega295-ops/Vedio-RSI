...
Prefer multiple-choice prompts for both boundary and properties, but keep them editable. Choices are config boundaries/properties, not final ontology terms.
